...
if uploaded_file:
    ...
    for col in ["Volume", "Catacao", "Custo"]:
    ...
    elif df[["Volume", "Catacao", "Custo"]].isnull().any().any():
        st.error("❌ Há valores não numéricos ou ausentes nas colunas Volume, Catacao ou Custo. Verifique o CSV.")
    else:
